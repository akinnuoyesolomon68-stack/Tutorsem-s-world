  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-100 py-12 px-6 md:px-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="col-span-1 md:col-span-2">
          <Link to="/" className="text-xl font-semibold tracking-tight text-gray-900 group">
            TUTORSEM's World<span className="text-teal-600 transition-colors">.</span>
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            ...
            <li><Link to="/portfolio" className="hover:text-teal-600 transition-colors">Portfolio</Link></li>
            <li><Link to="/vision" className="hover:text-teal-600 transition-colors">Vision & Goals</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li><Link to="/marketplace" className="hover:text-teal-600 transition-colors">Accessories</Link></li>
            <li><Link to="/marketplace" className="hover:text-teal-600 transition-colors">Student Materials</Link></li>
            <li><Link to="/marketplace" className="hover:text-teal-600 transition-colors">Clothes & Shoes</Link></li>
          </ul>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between">
        ...
        <Link to="/admin" className="text-sm text-gray-400 hover:text-teal-600 mt-4 md:mt-0 transition-colors">
          Admin Access
        </Link>
      </div>
    </footer>
